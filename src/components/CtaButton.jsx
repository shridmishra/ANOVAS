    ...
    <div className="flex justify-center lg:justify-start">
      <div className="relative inline-block group">
        <button className="relative flex items-center justify-start p-4 rounded-full bg-white text-black hover:text-white hover:bg-gradient-to-r from-indigo-600 to-purple-500">
          {/* Circle with icon */}
          <div className="flex items-center justify-center w-8 h- md:w-10 md:h-10 bg-gradient-to-r from-indigo-600 to-purple-500 rounded-full transition-transform duration-300 ease-in-out transform lg:group-hover:translate-x-56 group-hover:translate-x-44 hover:text-black group-hover:bg-white">
